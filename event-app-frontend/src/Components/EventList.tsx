...
function EventList(props: CategoryProps) {
    ...
    return (
        <div style={{backgroundImage: 'url(/background.jpg)', height: '200vh'}}>
            <Navbar/>
            ...
            <div style={{display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center'}}>
                {filteredEvents.map((event) => (
                    <Card key={event.eventId} raised={true} style={{
